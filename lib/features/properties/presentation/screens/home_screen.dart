...
EOF~
sed -i 's/EOF~$//' ~/kubico/lib/features/profile/presentation/screens/profile_screen.dart
tail -5 ~/kubico/lib/features/profile/presentation/screens/profile_screen.dart

tail -5 ~/kubico/lib/features/profile/presentation/screens/profile_screen.dart
~~~~~~mkdir -p ~/kubico/lib/features/profile/presentation/screens && cat > ~/kubico/lib/features/profile/presentation/screens/profile_screen.dart << 'EOF'
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import '../../../../core/theme/app_theme.dart';
import '../../../auth/presentation/providers/auth_provider.dart';
